...
import torch
from torchvision import transforms   #Transforms can be used to transform or augment data for training or 
#inference of different tasks (image classification, detection, segmentation, video classification).
...
if __name__ == "__main__":
    default_transform = transforms.Compose(
        [
            ...
            transforms.ToTensor(),   #Tensor conversion is necessary for the images to be compatible with PyTorch models.
            transforms.Normalize(
                [0.61567986, 0.6217983, 0.60718144],
                [0.13666723, 0.13178031, 0.13231377],
            ),
        ]   # The tensor is normalized using the specified mean and standard deviation.
    )
